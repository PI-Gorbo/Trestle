...
/**
 * The GitHub mark as inline SVG. `@lucide/vue` v1 dropped brand icons, so there is no
 * `GithubIcon` to import — this stands in for one, and takes its size and colour from the
 * classes the caller passes, exactly as a lucide icon does.
 */
</script>
